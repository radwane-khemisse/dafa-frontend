...
export default function PrivacyPage() {
  return (
    <PolicyPage
      ...
      intro="نتعامل مع بيانات العميل باعتبارها جزءا من تجربة طلب موثوقة: نستخدمها لتأكيد المنتج والكمية، الشحن، وخدمة ما بعد الطلب فقط بالقدر اللازم."
      items={[
        {
          icon: Smartphone,
          title: "بيانات الطلب",
          text: "نستخدم بيانات الطلب لتأكيد المنتج، العرض المختار، رقم الجوال، العنوان، وتجهيز الشحن وخدمة العملاء.",
        },
        {
          icon: Megaphone,
